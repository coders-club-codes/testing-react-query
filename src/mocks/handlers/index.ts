...
import { ApiResponse, Post, User } from '../../common/types';
import { ENV } from '../../constants';

const composeEndpoint = (endpoint: string) =>
  `${ENV.REACT_APP_DUMMYAPI_URL}${endpoint}`;

export const handlers = [
  rest.get<undefined, ApiResponse<User[]>>(
    composeEndpoint('user'),
    (_req, res, ctx) =>
      res(
        ctx.status(200),
        ctx.json({
  ...
  rest.get<undefined, ApiResponse<Post[]>>(
    composeEndpoint('post'),
    (_, res, ctx) =>
      res(
        ctx.status(200),
        ctx.json({
          data: [
            {
              ...
              id: '60f94a11c142456a226b5946',
              likes: 0,
              tags: [],
              appId: '60d0c9c111f09556e2187758',
              publishDate: '2021-07-22T10:36:01.856Z',
              updatedAt: '2021-07-22T10:36:01.856Z',
            },
            {
              owner: {
                id: '60d0fe4f5311236168a10a2c',
            ...
            },
            {
              ...
              text:
                'ice caves in the wild landscape photo of ice near gray cliff',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1568480541687-16c2f73eea4c.jpg',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1517884467367-ac2e21e46d0b.jpg',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1548658146-f142deadf8f7.jpg',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1535008652995-e95986556e32.jpg',
              publishDate: '2020-05-21T15:53:26.275Z',
              text:
                'Random man walking with his dogs man and dogs on the seashore',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1580734075803-ac9cdb54fb03.jpg',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1558556249-076e42967a24.jpg',
            ...
            },
            {
              ...
              image:
                'https://img.dummyapi.io/photo-1556526588-a0bd9b5a42c3.jpg',
